<template>
    <div class="sidebar">
        <aside class="hidden z-50 sidebar-desktop pt-0 w-48 text-white bg-gray-700 fixed inset-y-0 overflow-x-hidden overflow-y-auto sm:block">
            <div class="p-4 min-h-full">
                ...
                <div class="px-6 pb-6 flex items-center border-b border-green-100 sm:flex-col">
                    ...
                    <div class="mr-auto text-white flex-shrink-0 flex justify-center items-center rounded-full border-4 sm:mt-4 sm:mx-auto">
                        <svg class="fill-current w-12 sm:w-12" viewBox="0 0 24 24">
                    ...
                    <div class="ml-4 flex-1 flex flex-col sm:mt-4 sm:ml-0 sm:items-center">
                        ...
                        <div class="text-red-500 text-xl sm:text-sm">10.000 BET</div>
                    </div>
                </div>
